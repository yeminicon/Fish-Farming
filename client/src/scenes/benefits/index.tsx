  ...
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
      ...
      >
        ...
        >
          <HText>MORE THAN JUST PLACE.</HText>
          <p className="my-5 text-sm">
           
            is a professional service framework offering a suite of agricultural 
            management solutions for CEA facilities. We provide true
